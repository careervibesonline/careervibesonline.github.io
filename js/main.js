...
(function($) {
    ...
    function pageBackground() {
        ...
        if (body.hasClass('image-background')) { // Image background
            $.backstretch(["https://radars.co.in/radarsbg.jpg"]); // Replace here Image Background
        } else if (body.hasClass('slideshow-background')) { // Slideshow background
            $.backstretch([
                "https://radars.co.in/radarsbg.jpg", // Add different images
                "https://radars.co.in/radarsbg.jpg",
                "https://radars.co.in/radarsbg.jpg",
                "https://radars.co.in/radarsbg.jpg",
                "https://radars.co.in/radarsbg.jpg"
            ], {
            ...
            if (!$('html').hasClass('touch') && !body.hasClass('mobile')) { // Detect mobile devices
                ...
                $.backstretch(["https://radars.co.in/radarsbg.jpg"]);
            }
        }
    }
    pageBackground();
